(function () {
    ...
    angular
        .module("umbraco")
        .component("blockGridPropertyEditor", {
            templateUrl: "views/propertyeditors/blockgrid/blockgrid.component.html",
    ...
    function BlockGridController($scope, $interpolate, editorService, clipboardService, localizationService, overlayService, blockEditorService) {
        ...
        function getBlockModel(entry) {
            ...
            block.view = "views/propertyeditors/blockgrid/blockviews/labelblock/blockgrid.labelblock.editor.html";
