...
(function () {
    ...
    function ElementTypePickerController($scope, elementTypeResource, overlayService, localizationService, editorService) {
        ...
        $scope.$watchCollection('model.value.length', function(newVal, oldVal) {
            evaluateStatus();
        });

    }

    angular.module("umbraco").controller("Umbraco.PropertyEditors.BlockGrid.ElementTypePickerController", ElementTypePickerController);
